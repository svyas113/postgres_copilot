...
async def handle_revise_query_iteration(
    ...
    for attempt in range(MAX_REVISE_SQL_RETRIES + 1):
        ...
        try:
            ...
            last_error_feedback_to_llm = f"Error processing your response: {e}. Response snippet: {llm_response_text[:100]}"
            if attempt == MAX_REVISE_SQL_RETRIES:
                return {
                    "revised_sql_query": None, "revised_explanation": None,
                    "message_to_user": f"Failed to revise SQL after multiple attempts. Last error: {e}"
                }
    ...
    try:
        ...
        execution_error = f"Exception during revised SQL execution: {e}"
        ...
        try:
            ...
            if attempt == MAX_NLQ_GEN_RETRIES:
                return {
                    ...
                    "message_to_user": f"Failed to generate NLQ for revised SQL. Last error: {e}"
                }
